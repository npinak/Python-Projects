...
class MyGame(arcade.Window):
    ...
    def on_mouse_motion(self, x, y, dx, dy):
        ...
        # Updating the movement variable to unfreeze the game when the player moves their sprite
        if (self.player_sprite.center_x or self.player_sprite.center_y != 50):
            self.movement = 1
    ...
    def update(self, delta_time):
        ...
        # Start moving the Stars and Orbs when the player moves their mouse.
        if self.movement == 1:
