...
SCREEN_TITLE = "PyMunk Top-Down_Asteroid-Remake"
...
class MyWindow(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.player_sprite = arcade.Sprite("/Users/pinaknayak/Documents/Github/Python-Projects/"
                                           "Python_Arcade/Labs/Asteroids/images/playerShip1_orange.png",
        ...
        for y in range(SPRITE_SIZE, SCREEN_HEIGHT, SPRITE_SIZE):
            ...
            wall.center_y = y
            self.wall_list.append(wall)''' # Walls
